...
- Even when the article body is inaccessible, meta tags are always readable
...
# Extraction patterns (note: og:article:author uses a colon-prefixed property attr)
_META_PATTERNS = {
    'title': [
...
def meta_to_dict(meta: ArticleMeta) -> dict:
    """Convert to dict for easy JSON serialisation."""
    return {
        'title': meta.title,
        'author': meta.author,
